 ...
 */
public abstract class Mesh extends MeshBase implements 
        SceneDrawable
        {
    ...
    private float maxDrawDistance = 500f;
    private float maxDrawDistanceSquere = maxDrawDistance*maxDrawDistance;
    ...
    public void setMaxVisibilityDistance(float maxDrawDistance) {
        this.maxDrawDistance = maxDrawDistance;
        this.maxDrawDistanceSquere = maxDrawDistance*maxDrawDistance;
    }
    ...
    public boolean isAlwaysDrawable() {
        return alwaysDrawable;
    }
    ...
    protected boolean isDrawable(){
        ...
        return getPosition().distanceSquereFromVector(camera.getEYE())<maxDrawDistanceSquere;
    }
    
    protected void doBeforeDraw(Camera camera){
        updateMVPMatrix(camera);
        useShaderProgram();
        setUniforms();
        setAttibuteDatas();        
    }
    ...
    protected abstract void useShaderProgram();
